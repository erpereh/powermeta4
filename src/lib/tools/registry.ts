...
export const TOOL_MODULES = [
  {
    id: "users",
    name: "Usuarios",
    description: "Gestiona las personas que utilizan este workspace.",
    route: "/tools/users",
    icon: "users",
    tools: [
      tool({
        ...
        description: "Guarda un usuario en la empresa activa.",
      ...
      tool({
        ...
        description: "Busca usuarios por sus datos básicos.",
        route: "/tools/users/search",
        icon: "user-search",
      ...
      tool({
        ...
        description: "Acceso preparado para actualizar datos de usuario.",
        route: "/tools/users",
        icon: "user-settings",
      ...
      tool({
        ...
        description: "Acceso preparado para gestionar bajas de usuario.",
        route: "/tools/users",
