...
- Al personalizar un componente externo, conservar primero su estructura y
  primitivas oficiales; revisar una copia y el diff antes de sobrescribir el
  componente del proyecto.
- Una adaptación visual no debe sustituir el comportamiento, el contexto ni
  las transiciones del componente base.
